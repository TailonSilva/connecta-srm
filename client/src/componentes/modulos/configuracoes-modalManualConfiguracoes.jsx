    ...
    <ModalManualPagina
      ...
      cardsResumo={[
        ...
        },
        {
          ...
          detalhe: `${gruposEmpresa.length} grupo(s) de empresa ja carregados para reutilizacao nos fornecedores.`,
          icone: 'cadastro'
        },
        {
          titulo: 'Perfil atual',
      ...
      cardsRegras={[
        ...
        },
        {
          ...
          descricao: 'Ao salvar configuracoes da empresa, o sistema dispara eventos para recarregar telas dependentes, como a pagina inicial e regras de exibicao ligadas ao cadastro de fornecedores.',
        ...
        },
        {
          ...
          descricao: 'Quando um grupo de empresa muda, os contatos herdados dos fornecedores vinculados sao sincronizados automaticamente.',
