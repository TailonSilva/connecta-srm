      ...
      blocosTexto={[
        {
          ...
          itens: [
            'Fornecedor e contato entram no mesmo fluxo da cotacao e abastecem a proposta comercial.',
            'Na busca de fornecedores da cotacao, Usuario padrao tambem pode selecionar fornecedores vinculados a outros compradores para montar novas propostas.',
            'Selecionar ou trocar o fornecedor nao puxa mais o comprador do cadastro do fornecedor; o comprador inicial da cotacao sempre segue o usuario do registro e so muda quando o proprio campo Comprador for alterado no modal.',
            'A busca de fornecedores tambem permite incluir um novo fornecedor sem sair do fluxo.',
            'Ao abrir a busca de contatos com um fornecedor ja definido, o proprio modal permite cadastrar um novo contato e devolver esse contato ja selecionado na cotacao.',
            'Quando o foco estiver em Fornecedor ou Contato, `F8` abre a busca correspondente sem depender do clique no botao lateral.',
            'Ao confirmar a busca de fornecedor ou contato, o foco retorna para o campo preenchido na cotacao.',
            ...
            'A aba Outros concentra o Ordem de Compra vinculado e os dados complementares da cotacao.',
        ...
        },
        {
          ...
          itens: [
            'A pesquisa textual e os filtros ajudam a localizar propostas por fornecedor, usuario, comprador, etapa e um botao Datas que abre o painel com os periodos de inclusao e fechamento.',
            ...
            'As colunas foram redistribuidas para evitar rolagem horizontal e agora separam codigo, fornecedor, contato, etapa, comprador e total em campos proprios.',
            'A configuracao do grid tambem pode incluir a coluna Conceito do fornecedor para apoiar leitura comercial sem abrir o cadastro.',
